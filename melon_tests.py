...
class ShippingTestCase(unittest.TestCase):
    """Test functions related to shipping."""
...
class MelonSiteIntegrationTestCase(unittest.TestCase):
    ...
    def test_melon_order_form(self):
        ...
        melon_option = b'<option value="alib">Ali Baba Watermelon</option>'
    ...
    def test_melon_order(self):
        ...
        # the melon listing page.
        self.assertIn(b'Your order total comes to $', result.data)
        page_title = b'<h1>Ubermelon\'s Artisinal, Bespoke Melon Selection</h1>'
    ...
    def test_melon_detail(self):
        ...
        self.assertEqual(result.status_code, 200)
        self.assertIn(b'Watermelon', result.data)
